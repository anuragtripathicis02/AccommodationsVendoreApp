            ...
            <div className='menu-logo-box d-flex align-items-center justify-content-between gap-2'>
                ...
                {/* <button className="btn bg-transparent border-0 p-0" type="button" >
                    <span className="mobile-nav">
                        <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="0.75" y="1.60156" width="16.5" height="14.25" rx="1.25" stroke="#3D3D3D" strokeWidth="1.5"/><line x1="6.375" y1="1.97656" x2="6.375" y2="16.6016" stroke="#3D3D3D" strokeWidth="1.5"/></svg>
                    </span>
                </button> */}
            </div>
