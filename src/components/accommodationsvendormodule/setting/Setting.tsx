...
const Setting = () => {
  ...
  return (
    <div className='setting-sec'>
        <Link href="" className='setting-box d-flex align-items-center gap-2 justify-content-between' onClick={() => setShowChangePassword(true)} >
        ...
        <Link href="" className='setting-box d-flex align-items-center gap-2 justify-content-between'  onClick={() => setShowPayoutMethod(true)} > 
            <div className='left-text-box'>
        ...
        <PayoutMethodModal show={showPayoutMethod} handleClose={() => setShowPayoutMethod(false)}/>
