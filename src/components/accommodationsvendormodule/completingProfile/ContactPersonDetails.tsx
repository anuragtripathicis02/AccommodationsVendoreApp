...
const ContactPersonDetails: React.FC<Props> = ({ nextStep }) => {
    ...
    const handleDrop = (e: React.DragEvent, target: 'userId' | 'document') => {
        e.preventDefault();
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>, target: 'userId' | 'document') => {
    ...
    const triggerUpload = (target: 'userId' | 'document') => {
        if (target === 'userId') inputRefUserId.current?.click();
        else inputRefDocument.current?.click();
    };
                            ...
                            <div className='col-md-6'>
                                ...
                                <div className="form-group mb-24">
                                    ...
                                    <Form.Select aria-label="Default select example">
                                        ...
                                        <option value="1">Squchapplication@gmail.com One</option>
                                        <option value="2">Squchapplication@gmail.com Two</option>
                                        <option value="3">Squchapplication@gmail.com Three</option>
                                    </Form.Select>
                                </div>
