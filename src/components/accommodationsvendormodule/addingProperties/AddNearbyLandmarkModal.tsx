...
const AddNearbyLandmarkModal = ({ show, handleClose }: any) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} centered className="modal-filter common-modal-sec pt-4">
        ...
        <Modal.Body className="common-modal-body pt-4">
            <div className='modal-box'>
                <div className='heading'>
                    <h2>Add Attraction/Landmark</h2>
                </div>
                <Form>
                    <div className='landmark-modal-sec'>
                         <div className='row'>
                            ...
                            <div className='col-md-12'>
                                <div className="form-group mb-24">
                                    <Form.Label>Title of Location</Form.Label>
                                    <Form.Control type="text" placeholder='Pickup from Airport upto 4 guest' />
                                </div>
                            </div>
                            <div className='col-md-6'>
                                <div className="form-group mb-24">
                                    ...
                                    <Form.Select aria-label="Default select example">
                                        ...
                                        <option value="1">Landmark one </option>
                                        <option value="2">Landmark two</option>
                                    </Form.Select>
                                </div>
                            </div>
                            <div className='col-md-6'>
                                <div className="form-group mb-24 placeholder-dark">
                                    <Form.Label>Distance From Property</Form.Label>
                                    <Form.Control type="text" placeholder='12 Km' />
                                </div>
                            </div>
                            <div className='col-md-12'>
                                <div className="form-group mb-24 height-box-fixed placeholder-dark">
                                    <Form.Label>Description</Form.Label>
                                    <Form.Control as="textarea" rows={3} placeholder='Escape to Sunset Bay Resort, where luxury meets nature. Nestled along the serene coastline, our resort offers stunning ocean views, world-class amenities, and warm hospitality for families, couples, and solo travelers.'/>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default AddNearbyLandmarkModal