            ...
            <div className='row'>
                ...
                <div className='col-md-8'>
                    <div className="form-group mb-24 placeholder-dark">
                        <Form.Label >Property Tag Line</Form.Label>
                        <Form.Control type="text" placeholder='Room in Ernakulam, India' />
                    </div>
                </div>
                <div className='col-md-4'>
                    <div className="form-group mb-24 placeholder-dark">
                        ...
                        <Form.Select aria-label="Default select example">
                            ...
                            <option value="1">Hotel/Room Booking one </option>
                            <option value="2">Hotel/Room Booking two</option>
                        </Form.Select>
                    </div>
                </div>
                <div className='col-md-4'>
                    ...
                    <div className="form-group mb-24">
                        ...
                        <Form.Select aria-label="Default select example">
                            <option>Tamele</option>
                            <option value="1">Tamele one </option>
                            <option value="2">Tamele two</option>
                        </Form.Select>
                    </div>
                    <div className="form-group mb-24">
                    ...
                    <div className="form-group mb-24">
                        ...
                        <Form.Control type="text" placeholder='put landmark' />
                    </div>
                    <div className="form-group mb-24 height-box-fixed">
                        <Form.Label >Full Address</Form.Label>
                        <Form.Control as="textarea" rows={3} placeholder='123456'/>
                    </div>
                </div>
                <div className="col-md-8 mt-md-0 ">
                    <div className='from-group h-100'>
