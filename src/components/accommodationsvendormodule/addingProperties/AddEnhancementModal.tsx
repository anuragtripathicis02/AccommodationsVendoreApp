...
const AddEnhancementModal  = ({ show, handleClose }: any) => {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group mb-24">
                                            <Form.Label>Enhancement Title</Form.Label>
                                        ...
                                        <div className="form-group mb-24">
                                            ...
                                            <Form.Select aria-label="Default select example">
                                                ...
                                                <option value="1">Rental one </option>
                                                <option value="2">Rental two</option>
                                            </Form.Select>
                                        </div>
                                        <div className="form-group mb-24">
                                            <Form.Label >Payout Slot</Form.Label>
                                            <Form.Select aria-label="Default select example">
