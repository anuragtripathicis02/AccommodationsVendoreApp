...
const CompleteProfile : React.FC<Props> = ({ nextStep }) => {
          ...
          <div className='col-md-8'>
            <div className='row'>
                ...
                <div className='col-md-6'>
                    ...
                    <Form.Select aria-label="Default select example">
                        <option>-- Select Value --</option>
                        <option value="1">Ostin One</option>
                        <option value="2">Ostin Two</option>
                        <option value="3">Ostin Three</option>
                        </Form.Select>
                    </div>
                </div>   
                <div className='col-md-12'>
                    <div className="form-group mb-24">
                        <Form.Label >Enter Complete Address</Form.Label>
