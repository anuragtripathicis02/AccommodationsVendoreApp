...
const About = () => {
  return (
    <div className='about-text-box mb-4 card-box p-16'>
        ...
        <div className='about-this-palce'>
            <p>An ensuite double bedroom in a spacious, comfortable flat, conveniently located on a quiet square by Dalston Junction station.  Just behind a high street with restaurants, bars, and ...</p>
        </div>
    </div>
  )
}
