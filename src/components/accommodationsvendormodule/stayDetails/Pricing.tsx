...
import StayDetailsPricingModal from './StayDetailsPricingModal'

const Pricing = () => {
      const [showPromoChange, setShowPromoChange] = useState(false);
  return (
    <div className='pricing-sec card-box p-16 mb-4'>
        <div className='table-top d-flex align-items-center flex-md-nowrap flex-wrap justify-content-between gap-3'>
            ...
            <div className='right-box'>
                <Link href="" className='btn btn-edit btn-border d-flex align-items-center gap-2'  onClick={() => setShowPromoChange(true)} >
        ...
        <div className='pricing-bottom-box'>
            <ul>
                <li className='d-flex align-items-center gap-2 justify-content-between'>
                    <span className="text-start">General Stay Per Night</span>
                    <span className='text-end'>$ 1250</span>
                </li>
                <li className='d-flex align-items-center gap-2 justify-content-between'>
                    <span className="text-start">Min. Advance Booking Amount</span>
                    <span className='text-end'>$ 200</span>
                </li>
                <li className='d-flex align-items-center gap-2 justify-content-between'>
                    <span className="text-start">Pay at Check In</span>
                    <span className='text-end'>Cash, Card, Online Transfer</span>
                </li>
            </ul>
        </div>

        <StayDetailsPricingModal  show={showPromoChange} handleClose={() => setShowPromoChange(false)} />
    </div>
  )
}
