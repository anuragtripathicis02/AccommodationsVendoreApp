...
const CreateCustomPricingModal = ({ show, handleClose }: any) => {
  return (
    <Modal show={show} onHide={handleClose} centered className="common-modal-sec pt-4 modal-add-pricing">
        <Modal.Header>
        ...
        <Modal.Body className="common-modal-body">
            <div className='heading'>
                <h2 className='mb-3'>Create Custom Pricing</h2>
            </div>
            <div className='modal-box'>
                <div className='row p-0'>
                    ...
                    <div className='col-md-6'>
                        ...
                        <Form.Control type='text' placeholder='$ 2350' />
                        </div>
                    </div>
                    <div className='col-md-6'>
                        <div className="form-group mb-24">
...
export default CreateCustomPricingModal