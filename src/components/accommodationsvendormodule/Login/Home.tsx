      ...
      <div className="auth-form">
        ...
        <div className="auth-banner-wrapper">
          ...
          <div className="card card-auth-form">
            <div className="block-head text-center mb-md-4 mb-0">
            ...
            <div className="form-group mb-24">
              <div className="form-group position-relative password-fild">
                <Form.Label htmlFor="text7">Your Password</Form.Label>
            ...
            <div className="forgot-link text-center  mb-24">
            ...
            <div className="sec-privacy-policy text-center">
              <h5 className="m-0 text-center">
                By logging in, i agree to Squch's{" "}
